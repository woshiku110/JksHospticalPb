...
function addQos(){
    ...
    msg += "\<div class = add_qos_item>";
        msg += "\<div style = display:flex;align-items:center;margin-top:10px >";
            ...
            msg += "\<select style= width:60px;height:30px;margin-left:10px >";
                msg += "\<option>单选</option>";
                msg += "\<option>多选</option>";
            msg += "\</select>";
            msg += "\<a style=margin-left:10px >题干：</a>";
            msg += "\<input style=width:100px;height:30px;margin-left:10px; type=text; placeholder='输入问题';  />";
        msg += "\</div>";
        msg += "\<div style=display:flex;width:1000px;flex-direction:row;flex-wrap:wrap >";
            msg += "\<div class=add_qos_item_ans >";
                msg += "\<a>A:</a>";
                msg += "\<input style=width:100px;height:30px;margin-left:10px; type=text onblur=blurAns(this) onfocus=fousAns(this) />";
